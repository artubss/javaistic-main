...
description: "Neste tutorial, aprenderemos como usar os construtores Java com exemplos práticos"
difficulty: "Básico"
category: "Programação Orientada a Objetos"
---

Um construtor em Java é similar a um método que é invocado quando um objeto da classe é criado.

Diferente dos métodos Java, um construtor tem o mesmo nome da classe e não tem nenhum tipo de retorno. Por exemplo,
